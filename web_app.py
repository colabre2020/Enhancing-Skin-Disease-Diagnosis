...
def initialize_models():
    ...
    if CORE_MODELS_AVAILABLE and create_demo_model is not None and InterpretabilityEngine is not None:
        try:
        ...
        logger.info("Core ML dependencies unavailable. Using lightweight mode.")
        model = None
        interpretability_engine = None
